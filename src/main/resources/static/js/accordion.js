...
const informationBlack = document.querySelector('.info_circle_black');
...
accordionBtn.addEventListener('click', () => {
    if (accordionContents.classList.contains('dropdown')) {
        ...
        informationBlack.classList.remove('dropdown');
        bottomArrow.classList.remove('dropdown');
    } else {
        ...
        informationBlack.classList.add('dropdown');
    }
});